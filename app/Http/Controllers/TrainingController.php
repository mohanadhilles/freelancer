...
class TrainingController extends Controller
{
    ...
    public function create()
    {
        ...
        if (file_exists(resource_path('views/extend/back-end/freelancer/training/create.blade.php'))) {
            return view(
                'extend.back-end.freelancer.training.create',
                compact(
                    'english_levels',
                    'languages',
                    'categories',
            ...
            return view(
                'back-end.freelancer.training.create',
                compact(
                    'english_levels',
                    'languages',
                    'categories',
        ...
        if (!empty($selected_service)) {
            ...
            if (!empty($service)) {
                if (file_exists(resource_path('views/extend/front-end/services/show.blade.php'))) {
                    return view(
                        'extend.front-end.training.show',
                        compact(
                            'service',
                            'symbol',
                            'delivery_time',
    ...
    public function edit($id)
    {
        ...
        if (file_exists(resource_path('views/extend/back-end/freelancer/services/edit.blade.php'))) {
            ...
            return view(
                'back-end.freelancer.training.edit',
                compact(
                    'english_levels',
                    'languages',
                    'categories',
        ...
        if (Auth::user() && !empty($id)) {
            if (Auth::user()->getRoleNames()->first() === 'employer') {
                ...
                if (file_exists(resource_path('views/extend/back-end/employer/services/checkout.blade.php'))) {
                    return view(
                        'extend.back-end.employer.training.checkout',
                        compact(
                            'stripe_img',
                            'service',
                            'freelancer_name',
                    ...
                    return view(
                        'back-end.employer.training.checkout',
                        compact(
                            'stripe_img',
                            'service',
                            'freelancer_name',
    ...
    public function adminServices()
    {
        ...
        if (file_exists(resource_path('views/extend/back-end/admin/services/index.blade.php'))) {
            return view(
                'extend.back-end.admin.training.index',
                compact('services', 'symbol', 'status_list')
            );
        } else {
            return view(
                'back-end.admin.training.index',
                compact('services', 'symbol', 'status_list')
            );
        }
    }
    ...
    public function adminServiceOrders()
    {
        ...
        if (file_exists(resource_path('views/extend/back-end/admin/services/order.blade.php'))) {
            return view(
                'extend.back-end.admin.training.order',
                compact('orders', 'symbol', 'payment_methods')
            );
        } else {
            return view(
                'back-end.admin.training.order',
                compact('orders', 'symbol', 'payment_methods')
            );
        }
    }
